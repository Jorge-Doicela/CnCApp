...
-- CreateIndex
CREATE UNIQUE INDEX "competencias_Nombre_Competencia_key" ON "competencias"("Nombre_Competencia");

-- CreateIndex
CREATE UNIQUE INDEX "instituciones_sistema_Nombre_Institucion_key" ON "instituciones_sistema"("Nombre_Institucion");
...
-- AddForeignKey
ALTER TABLE "Usuario" ADD CONSTRAINT "Usuario_Id_Provincia_fkey" FOREIGN KEY ("Id_Provincia") REFERENCES "Provincias"("Id_Provincia") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Usuario" ADD CONSTRAINT "Usuario_Id_Canton_fkey" FOREIGN KEY ("Id_Canton") REFERENCES "Cantones"("Id_Canton") ON DELETE SET NULL ON UPDATE CASCADE;
